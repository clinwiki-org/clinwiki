...
import '!file-loader?name=[name].[ext]!./images/clinwiki-501.png';
import '!file-loader?name=[name].[ext]!./images/gold_star.png';
import '!file-loader?name=[name].[ext]!./images/silver_star.png';
import '!file-loader?name=[name].[ext]!./images/star_outline.png';
