...
function removeEscapeCharactersAndPunctuation(_a) {
    var str = _a.str;
...
exports.removeEscapeCharactersAndPunctuation = removeEscapeCharactersAndPunctuation;
function removeEscapeCharacters(_a) {
    var str = _a.str;
    str = str.replace(/\\\\n/g, "");
    str = str.replace(/\\n/g, "");
    str = str.replace(/\\/g, "");
