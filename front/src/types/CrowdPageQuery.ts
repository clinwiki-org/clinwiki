...
export interface CrowdPageQuery_study {
  __typename: "Study";
  acronym: string | null;
  ages: string;
  ...
  wikiPage: CrowdPageQuery_study_wikiPage | null;
}

export interface CrowdPageQuery_me {
  __typename: "User";
  /**
   * Id
   */
...
export interface CrowdPageQuery {
  study: CrowdPageQuery_study | null;
  /**
   * Current logged in user
   */
  me: CrowdPageQuery_me | null;
}

export interface CrowdPageQueryVariables {
  nctId: string;
}
