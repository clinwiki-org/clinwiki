...
export interface GenericStudySectionPageQuery_me {
  __typename: "User";
  /**
   * Id
   */
...
export interface GenericStudySectionPageQuery {
  study: GenericStudySectionPageQuery_study | null;
  /**
   * Current logged in user
   */
  me: GenericStudySectionPageQuery_me | null;
}

export interface GenericStudySectionPageQueryVariables {
  nctId: string;
}
