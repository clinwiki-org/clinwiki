...
export interface TagsPageQuery_study {
  __typename: "Study";
  acronym: string | null;
  ages: string;
  ...
  wikiPage: TagsPageQuery_study_wikiPage | null;
}

export interface TagsPageQuery_me {
  __typename: "User";
  /**
   * Id
   */
...
export interface TagsPageQuery {
  study: TagsPageQuery_study | null;
  /**
   * Current logged in user
   */
  me: TagsPageQuery_me | null;
}

export interface TagsPageQueryVariables {
  nctId: string;
}
