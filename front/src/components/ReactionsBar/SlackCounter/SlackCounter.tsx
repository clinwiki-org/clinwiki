...
class SlackCounter extends React.Component<
  SlackCounterProps,
  SlackCounterState
> {
  ...
  renderReactionButtons = () => {
    ...
    return this.props.activeReactions.map((reaction, index) => {
      let currentReaction = this.currentReactionFilter(reaction.name);

      let isUserReaction = this.findUserReaction(
        currentReaction,
        userReactionsCurrent
      );
            ...
            <DeleteReactionMutation>
              {deleteReaction => (
                <SlackCounterGroup
                  ...
                  active={' '}
                  onSelect={() =>
                    this.deleteReactionHelper(deleteReaction, isUserReaction)
                  }
                />
              )}
            </DeleteReactionMutation>
            ...
            <CreateReactionMutation>
              {createReaction => (
                <SlackCounterGroup
                  ...
                  active={' '}
                  onSelect={() =>
                    this.createReactionHelper(createReaction, currentReaction)
                  }
                />
              )}
            </CreateReactionMutation>
