...
export const OLD_SITE_STUDY_EXTENDED_GENERIC_SECTION_FRAGMENT = gql `
...
`;
export const OLD_SITE_STUDY_BASIC_GENERIC_SECTION_FRAGMENT = gql `
...
//TODO Delete old SV fragment once all Copy/CRUD for siteviews is moved on redux.

export const OLD_SITE_STUDY_PAGE_FRAGMENT = gql `
  ...
  ${OLD_SITE_STUDY_BASIC_GENERIC_SECTION_FRAGMENT}
  ${OLD_SITE_STUDY_EXTENDED_GENERIC_SECTION_FRAGMENT}
`;

//TODO Delete old SV fragment once all Copy/CRUD for siteviews is moved on redux.

export const OLD_SITE_VIEW_FRAGMENT = gql `
