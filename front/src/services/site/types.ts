...
export const FETCH_PRESENT_SITE_PROVIDER_SEND =
    'FETCH_PRESENT_SITE_PROVIDER_SEND';
export const FETCH_PRESENT_SITE_PROVIDER_SUCCESS =
    'FETCH_PRESENT_SITE_PROVIDER_SUCCESS';
export const FETCH_PRESENT_SITE_PROVIDER_ERROR =
    'FETCH_PRESENT_SITE_PROVIDER_ERROR';
...
export type SiteActionTypes =
    | FetchSiteProviderSendAction
    | FetchSiteProviderSuccessAction
    | FetchSiteProviderErrorAction
    | FetchPresentSiteProviderSendAction
    | FetchPresentSiteProviderSuccessAction
    | FetchPresentSiteProviderErrorAction
    ...
    | FetchSitesPageSendAction
    | FetchSitesPageSuccessAction
    | FetchSitesPageErrorAction
    | CreateSiteSendAction
    | CreateSiteSuccessAction
    | CreateSiteErrorAction
    | UpdateSiteSendAction
    | UpdateSiteSuccessAction
    | UpdateSiteErrorAction
    | DeleteSiteSendAction
    | DeleteSiteSuccessAction
    | DeleteSiteErrorAction
    | FetchAdminSiteViewSendAction
    | FetchAdminSiteViewSuccessAction
    | FetchAdminSiteViewErrorAction
    | CopySiteViewSendAction
    | CopySiteViewSuccessAction
    | CopySiteViewErrorAction
    | CreateSiteViewSendAction
    | CreateSiteViewSuccessAction
    | CreateSiteViewErrorAction
    | DeleteSiteViewSendAction
    | DeleteSiteViewSuccessAction
    | DeleteSiteViewErrorAction
    | UpdateSiteViewSendAction
    | UpdateSiteViewSuccessAction
