...
export const fetchAdminSiteViewSuccess = (
...
export const fetchAdminSiteViewError = (
    message: string
): types.SiteActionTypes => ({
...
export const fetchSitesPageError = (
    message: string
): types.SiteActionTypes => ({
...
export const fetchSiteProvider = (
    id?: number,
    url?: string
): types.SiteActionTypes => ({
...
export const fetchSiteProviderSuccess = (
...
export const fetchSiteProviderError = (
    message: string
): types.SiteActionTypes => ({
...
export const fetchPresentSiteProvider = (
    id?: number,
    url?: string
): types.SiteActionTypes =>
...
export const fetchPresentSiteProviderSuccess = (
...
export const fetchPresentSiteProviderError = (
    message: string
): types.SiteActionTypes => ({
...
export const createSiteViewError = (
    message: string
): types.SiteActionTypes => ({
...
export const deleteSiteViewError = (
    message: string
): types.SiteActionTypes => ({
...
export const updateSiteViewError = (
    message: string
): types.SiteActionTypes => ({
