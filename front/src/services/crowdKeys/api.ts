...
import { callHasuraClinwiki, getHasuraClinwikiURL } from 'utils/graphqlUtil';
...
export const updateCrowdKeyValueId = (crowdKeyValueIdPK, crowdValue) => {
    // console.log('mutation = ', mutate.UPDATE_CROWD_KEY_VALUE_ID);
    // console.log('input = ',     crowdKeyValueId,crowdValue  crowdKey);
    return callHasuraClinwiki(HASURA_CW, mutate.UPDATE_CROWD_KEY_VALUE_ID, {
        crowdKeyValueIdPK: crowdKeyValueIdPK,
